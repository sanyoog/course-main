...
export function ProgrammingPage({ data, completed, toggleCompleted, sectionIds, resetSection }: Props) {
  const { topics } = data.programmingFundamentals;
